...
data Instr
  = MOVE String String                -- x = y
  | MOVEI String Int                  -- x = constante
  | OP BinOp String String String     -- x = y op z
  | LABEL String                      -- Label:
  | JUMP String                       -- goto Label
  | COND String BinOp String String String -- if x op y goto Label1 else goto Label2
